...
*Open the project:*<br>
Run Code::Blocks, and open the project in `sdl-test/build/codeblocks`.<br>
Finally, build and run the project.
...
cd sdl-test
mkdir ../eclipse-sdl-test
cd ../eclipse-sdl-test

# Generate an Eclipse project
cmake ../sdl-test -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-sdl-test`.<br>
